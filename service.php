...
<body>
    ...
    <div class="container-fluid page-header">
        ...
        <div class="d-inline-flex text-white">
            <h6 class="text-uppercase m-0"><a class="text-white" href="index.php">Inicio</a></h6>
            <h6 class="text-body m-0 px-3">/</h6>
            <h6 class="text-uppercase text-body m-0">Nuestros Servicios</h6>
        </div>
    </div>
    <!-- Page Header Start -->
                ...
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            ...
                            <h1 class="display-2 text-black mt-n2 m-0">02</h1>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            ...
                            <h1 class="display-2 text-black mt-n2 m-0">03</h1>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            ...
                            <h1 class="display-2 text-black mt-n2 m-0">04</h1>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            ...
                            <h1 class="display-2 text-black mt-n2 m-0">05</h1>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            ...
                            <h1 class="display-2 text-black mt-n2 m-0">06</h1>
                        </div>
